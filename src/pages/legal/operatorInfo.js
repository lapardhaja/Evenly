/** Public operator contact used on Privacy / Terms / Cookies / Copyright / Security. */
export const OPERATOR_EMAIL = 'servetlap29@gmail.com';
export const OPERATOR_NAME = 'Servet Lapardhaja';
export const OPERATOR_PLACE = 'New York, New York';
