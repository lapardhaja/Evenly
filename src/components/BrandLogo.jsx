...
export function BrandMark({ title = 'Evenly', decorative = false, sx = {} }) {
  return (
    ...
    >
      <path d="M18 461Q4 438 4 402V108Q4 44 65 14Q82 6 140 6H221L33 463Q26 478 18 461Z" />
      <path d="M268 6H510Q492 70 452 101Q410 132 356 132H226L268 6Z" />
      <path d="M220 184H438Q420 248 382 280Q344 312 286 312H170L220 184Z" />
      <path d="M112 395H496Q480 456 436 492Q394 512 330 512H68L112 395Z" />
    </Box>
  );
}
