/**
 * Fallback when the live rate API is unreachable: currencies our FX provider
 * typically supports, minus withdrawn / non-cash codes (see WITHDRAWN_* in currencies.js).
 * Prefer `getCurrencySelectOptions()` which loads the current list from the API.
 */
export default [
  ...
  'HKD', 'HNL', 'HTG', 'HUF', 'IDR', 'ILS', 'IMP', 'INR', 'IQD', 'IRR', 'ISK', 'JEP', 'JMD', 'JOD',
  ...
  'XCG', 'XDR', 'XOF', 'XPF', 'YER', 'ZAR', 'ZMW', 'ZWG', 'ZWL',
];
