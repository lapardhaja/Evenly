...
create index group_people_group_id_idx on public.group_people (group_id);
...
-- Per-person quantity per item (dual maps collapsed to one source of truth)
